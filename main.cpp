...
//Fun��es de Arquivos
void salvar_lista_arquivos(); // Salva as altera��es do sistema na mem�ria secund�ria
...
void ordenar_letras(); // Ordena a lista de letras por ordem alfab�tica

//Fun��es de controle da lista de Palavras
int num_substring_em_string(const char string[], const char substring[]); // Retorna o n�mero de ocorr�ncias de uma substring dentro de uma string
...
//Fun��es extras
void listar_dicionario(); // Lista as palavras do dicion�rio na forma de �ndice remisso
void toupper_str(char* str); // Converte os chars de uma string para forma mai�scula
int strcont( /*1*/const char* string, /*2*/const char* substring); //Analisa se a string cont�m a substring
